...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonObs.setOnClickListener(v -> createObstacleInput(inflater, container));
        ...
        buttonCalculate.setOnClickListener(v -> {
            ...
            try {
                ...
                if (wallLengthStr.isEmpty() || wallHeightStr.isEmpty() || tileLengthStr.isEmpty() || tileHeightStr.isEmpty()) {
                    ...
                    Wall wall = new Wall(wallDimensions, tileDimensions, obstacles);
                    // Start New Activity
                    Intent intent = new Intent(MainActivity.this, DrawingActivity.class);
                    intent.putExtra("data", new CalculatedValuesWrapper(obstacles, wall));
